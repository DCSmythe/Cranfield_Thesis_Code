...
"""
This script generates the machine learning dataset to classify the data into high and low workload classes
...
Inputs:
    ...
    The directory path in which the dataset will be stored as 'high_low.data'
...
if __name__ == "__main__":
    ...
    with open(output_path + "/high_low.data", 'w', newline='') as high_low_f:
        csv_high_low = csv.writer(high_low_f)
        for path in os.listdir("data"):
            ...
            for i in range(0, 4):
                ...
                for j in range(4):
                    ...
                    maxs.append(np.abs(np.max(cut, axis=2)))
                ...
                for j in range(len(psd_mean)):
                    ...
                    # Determines whether the current file is a high or low workload
                    if true_phase % 2 == 0:
                        cars = 0
                    else:
                        cars = 1
